...
const app = {
    ...
    songsData : [
        {
            background: './assets/img/songs/05.jpg',
            name: 'All i want',
        ...
        {
            background: './assets/img/songs/01.jpg',
        ...
        {
            background: './assets/img/songs/07.jpg',
        ...
        {
            background: './assets/img/songs/04.jpg',
            name: 'Heat Waves',
        ...
        {
            background: './assets/img/songs/08.jpg',
            name: 'Comethru',
            singer: 'Zeremy zucker',
            pathSong: './assets/music/list-song/5.mp3',
            duration : '03:01',
        },
        {
            background: './assets/img/songs/03.jpg',
        ...
        {
            background: './assets/img/songs/06.jpg',
        ...
        {
            background: './assets/img/songs/02.png',
            name: 'Seve',
            singer: 'Tez Caday',
        ...
        {
            background: './assets/img/songs/09.jpg',
            name: 'Dandelions',
            singer: 'Ruth B',
        ...
        if (toatMain) {
            ...
            toast.innerHTML = `
                <div class="toast__item">
                    ...
                    <span> Mấy cái đó nó có tác dụng đâu mà  ;))))))) </span>
                </div>
            `;
    ...
    applyTheme: function() {
        themeItems.forEach((themeItem, index) => {
            themeItem.onclick = function() {
                if (index == 0) {
                    backgroundIndex = 0;
                    $('.heder').style.backgroundColor = `var(--header-color-${backgroundIndex})`;
                    $('.heder').style.boxShadow = '0 3px 5px rgba(0,0,0,0.1)';
                    $('.heder').style.backgroundColor = `var(--header-color-${backgroundIndex})`;
                    $('.heder').style.boxShadow = '0 3px 5px rgba(0,0,0,0.1)';
                    $('.main').style.backgroundImage = 'url(./assets/img/songs/mauden3.jpg)';
                    ...
                    $('.main').style.backgroundImage = 'url(./assets/img/songs/mautim.jpg)';
    ...
    renderNextSongListRandom: function(playListElement) {
        const htmls =  `<span class="nextsong__option-random">
                            Thôi mệt lắm không code nữa nghe nhạc là đủ rồi =))
                        </span>`
